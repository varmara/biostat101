...
Например: Риск остановки сердца различается у людей использующих и не использующих лекарство.
...
Давайте проверим, есть ли статистически значимые отличия длины интервала QTc после лечения от нормы.
