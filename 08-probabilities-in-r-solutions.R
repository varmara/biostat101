...
# P_{встреча и успешная охота} = P_{встреча} * P_{успешная охота|встреча} = 
0.035 * 0.40
...
# P_{умер в один из 365 дней} = 1 - P_{жив 365 дней}
...
# P_{моет|мужчина} = 0.74
# P_{моет|женщина} = 0.83
# P_{мужчина} = 0.4
# P_{женщина} = 0.6
# P_{моет} = P_{моет|мужчина} * P_{мужчина} + P_{моет|женщина} * P_{женщина}
